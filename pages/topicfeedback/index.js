...
import AddAssetDialog from "../../components/layouts/createCertificate";
import EditAssetDialog from "../../components/layouts/editCertificate";
import Enroll1 from "../../components/layouts/Enroll1";
...
import AddLocationDialog from "../../components/layouts/mytopic";
...
export default function Assets() {
  ...
  const[noOfyes,setNoOfYes]=useState(0)
  ...
  useEffect(() => {
    axios
      .post(API_URL + "topicfeedback/get_topicfeedback.php", {
      ...
      .then(function (response) {
        ...
        setUsers2(response.data?.topics);
  ...
  function deleteAssetFunc(id) {
    ...
    axios
      .post(API_URL + "certificate/delete_certificate.php", {
        id: id,
      })
      .then(function (response) {
    ...
    >
     ...
     <option value="2">Intermediate</option>
      <option value="3">Advanced</option>
                                    ...
                                    <div className="flex ">
                                      <div className="ml-4 space-y-2 md:space-y-0">
                                        ...
                                        <div class="flex  md:hidden ml-7 flex-1">
                                          ...
                                          <a
                                      onClick={() =>{
                                        handleEditLocation(person?.TopicId),setNoOfYes(person?.Yes),setNoOfNo(person?.No)
                                      }
                                      }
        ...
        {/* <Enroll1 id={myid} open={enroll} onChangeOpen={() => setEnroll(false)} /> */}
