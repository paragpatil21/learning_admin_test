...
import AddAssetDialog from "../../components/layouts/createQuiz";
import EditAssetDialog from "../../components/layouts/editQuiz";
...
const [mysearch,setMySearch]=useState();
  ...
  useEffect(() => {
    ...
    axios.post(API_URL + "quiz/get_quiz.php",{
...
if (response.data?.data) {
  ...
  function deleteAssetFunc(id) {
    ...
    axios
      .post(API_URL + "quiz/delete_quiz.php", {
        id: id,
      })
      .then(function (response) {
  ...
  return (
    <Template page="Chapter Assessments">
      <div className=" overflow-auto">
        <Head>
          <title>Chapter Assessments</title>
            ...
            <main className="py-10">
              <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
                <div className="flex flex-col justify-center lg:flex-row lg:justify-between lg:space-x-5">
                  <div>
                    <h1 className="text-2xl font-bold text-gray-900">Chapter Assessments</h1>
                  </div>
                  {addedSuccess ? (
                    <Notification
