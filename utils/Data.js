...
export const CourseList = [{code:"WAD",name:"Web Application Development"},{code:"SS",name:"Soft Skills"},{code:"ITES",name:"Information Technology Enabled services"}];
...
export const GenderList = ["Male","Female","LGBTQ+"];
...
export const LanguagesList = ["Telugu","Hindi","English","Marathi","Bengali","Tamil","Malayalam","Kannada"];
export const OtherIDList = ["Voter ID","Passport","Marks Card","PAN card"];
export const bplList = ["None","Orphan", "Semi Orphan","BPL"];
...
export const GaurdianRelationList = ["Father","Mother","Brother","Sister","Spouse","Other"];
...
// export const CourseList = [{code:"WMA",name:"Web and Mobile Application developement"},{code:"ITES",name:"Information Technology Enabled Services"}];
