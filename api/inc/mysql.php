...
class Mysql extends Config
{
    ...
    function join_all($table, $as, $fields, $join_array = array(), $condition =  "",  $order = "", $limit = "", $group_by = "",$offset="")
    {
    ...
    function get_all($table, $fields, $condition =  "", $order = "", $limit = "", $group_by = "",$offset="")
    {
        $sql_query = "SELECT $fields FROM `$table`";
        if (!empty($condition)) {
            $sql_query .= " WHERE $condition";
    ...
    function calculate_centers($condition){
    ...
    //intead you can use
    // function join_all_count($table, $as, $fields, $join_array = array(), $condition = "", $order = "", $limit = "", $group_by = "", $offset = "")
    // {
    
    //     $sql_query = "SELECT $fields, COUNT(r.regID) as student_count FROM `$table` $as";
    //     if (!empty($join_array)) {
    //         foreach ($join_array as $join) {
    //             foreach ($join as $key => $value) {
    //                 if ($key == 'on') {
